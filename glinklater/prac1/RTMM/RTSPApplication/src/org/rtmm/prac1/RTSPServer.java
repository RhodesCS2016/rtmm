...
public class RTSPServer extends JFrame implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 723140297841633983L;
	...
	public static void main(String argv[]) throws Exception
	{
		...
		while(true)
		{
			...
			else if (request_type == TEARDOWN)
			{
				...
				theServer.send_RTSP_Description();
			}
		}
	}
	...
	private void send_RTSP_Options() {
		...
		{
			System.out.println("Exception caught in send options: "+ex);
			System.exit(0);
		}
	}
	
	private void send_RTSP_Description() {
		try{
			RTSPBufferedWriter.write("RTSP/1.0 200 OK"+CRLF);
			RTSPBufferedWriter.write("CSeq: "+RTSPSeqNb+CRLF);
		...
		{
			System.out.println("Exception caught in send description: "+ex);
			System.exit(0);
		}
	}
